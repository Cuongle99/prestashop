...
<div class="wr-sale-stock">
    ...
    {if $product.show_availability}
      {if $product.availability == 'available'}
        <span class="product-available">{l s='In stock' d='Shop.Theme.Global'}</span>
      {elseif $product.availability == 'last_remaining_items'}
        <span class="product-unavailable">{l s='Last product' d='Shop.Theme.Global'}</span>
      {else}
        <span class="product-last-items">{l s='Out of stock' d='Shop.Theme.Global'}</span>
      {/if}
    {/if}
...
{block name='product_price_and_shipping'}
  {if $product.show_price}
    <div class="product-price-and-shipping {if $product.has_discount}product-discount{/if}">
