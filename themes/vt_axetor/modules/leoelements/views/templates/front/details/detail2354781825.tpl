...
{block name='page_content_container'}
  <section class="page-content" id="content" data-templateview="right" data-numberimage="5" data-numberimage1200="5" data-numberimage992="5" data-numberimage768="5" data-numberimage576="5" data-numberimage480="5" data-numberimage360="5" data-templatemodal="1" data-templatezoomtype="none" data-zoomposition="right" data-zoomwindowwidth="400" data-zoomwindowheight="400" data-use_leo_gallery="1">
...
{/block}
                            ...
                            </div><div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12 col-sp-12">{if $product.discount_type === 'percentage'}
              <span class="percentage">{l s='Save %percentage%' d='Shop.Theme.Catalog' sprintf=['%percentage%' => $product.discount_percentage_absolute]}</span>
            {/if}
{block name='page_header_container'}
	{block name='page_header'}
		<h1 class="h1 product-detail-name">{block name='page_title'}{$product.name}{/block}</h1>
	{/block}
{/block}<div class="product_after_title">{if isset($product_manufacturer->id)}
    ...
    {/if}
{hook h='displayLeoProductReviewExtra' product=$product}<div class="p-reference">
