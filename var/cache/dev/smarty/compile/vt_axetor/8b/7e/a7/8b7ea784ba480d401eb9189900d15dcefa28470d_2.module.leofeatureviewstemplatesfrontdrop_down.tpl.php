<?php
/* Smarty version 4.3.4, created on 2024-08-26 05:22:58
  from 'module:leofeatureviewstemplatesfrontdrop_down.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66cc4972a08568_31629785',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8b7ea784ba480d401eb9189900d15dcefa28470d' => 
    array (
      0 => 'module:leofeatureviewstemplatesfrontdrop_down.tpl',
      1 => 1690855550,
      2 => 'module',
    ),
  ),
...
function content_66cc4972a08568_31629785 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
<!-- begin D:\xampp\htdocs\prestashop\custom\vt_axetor/modules/leofeature/views/templates/front/drop_down.tpl -->	<?php if ($_smarty_tpl->tpl_vars['only_total']->value != 1) {?>
...
?><li style="width: <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['width_cart_item']->value, ENT_QUOTES, 'UTF-8');?>
px; height: <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['height_cart_item']->value, ENT_QUOTES, 'UTF-8');?>
px" class="leo-dropdown-cart-item clearfix<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['attributes']) && $_smarty_tpl->tpl_vars['show_combination']->value) || (smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['customizations']) && $_smarty_tpl->tpl_vars['show_customization']->value)) {?> has-view-additional<?php }
...
"><img class="img-fluid" src="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['images'][0]['bySize']['small_default']['url'], ENT_QUOTES, 'UTF-8');?>
...
"/></a>
							...
							<div class="leo-cart-item-info">					
								<div class="product-name"><a class="label" href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['url'], ENT_QUOTES, 'UTF-8');?>
" title="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8');?>
...
"
											data-min-quantity="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['minimal_quantity'], ENT_QUOTES, 'UTF-8');?>
"
											data-product-quantity="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['quantity'], ENT_QUOTES, 'UTF-8');?>
"
											data-quantity-available="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['quantity_available'], ENT_QUOTES, 'UTF-8');?>
"									
											type="text"
...
" 
								data-link-url="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['remove_from_cart_url'], ENT_QUOTES, 'UTF-8');?>
"
								data-id-product = "<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['id_product'],'javascript' )), ENT_QUOTES, 'UTF-8');?>
"
								data-id-product-attribute = "<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'],'javascript' )), ENT_QUOTES, 'UTF-8');?>
...
"
							...
							<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['attributes']) && $_smarty_tpl->tpl_vars['show_combination']->value) || (smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['customizations']) && $_smarty_tpl->tpl_vars['show_customization']->value)) {?>
							...
							<div class="leo-dropdown-additional">
								<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['attributes']) && $_smarty_tpl->tpl_vars['show_combination']->value) {?>							
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
								...
								<?php }?>
								<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['product']->value['customizations']) && $_smarty_tpl->tpl_vars['show_customization']->value) {?>
...
?>
													<li>
														<span class="label"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['field']->value['label'], ENT_QUOTES, 'UTF-8');?>
</span>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul>
			...
			<?php }?>
				<div class="leo-dropdown-total" data-cart-total="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['cart']->value['products_count'], ENT_QUOTES, 'UTF-8');?>
">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <?php echo htmlspecialchars((string) Tools::displayPrice($_smarty_tpl->tpl_vars['remaining_to_spend']->value,$_smarty_tpl->tpl_vars['currency']->value), ENT_QUOTES, 'UTF-8');?>
 <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'To get free ship!','mod'=>'leofeature'),$_smarty_tpl ) );?>
			...
			<?php if ($_smarty_tpl->tpl_vars['only_total']->value != 1) {?>
				<div class="leo-cart-dropdown-action clearfix">
					<a class="cart-dropdow-button cart-dropdow-viewcart btn btn-primary btn-outline" href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['cart_url']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View Cart','mod'=>'leofeature'),$_smarty_tpl ) );?>
					...
					<a class="cart-dropdow-button cart-dropdow-checkout btn btn-primary btn-outline" href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['order_url']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Check Out','mod'=>'leofeature'),$_smarty_tpl ) );?>
	...
	<?php }?>
<!-- end D:\xampp\htdocs\prestashop\custom\vt_axetor/modules/leofeature/views/templates/front/drop_down.tpl --><?php }
}
